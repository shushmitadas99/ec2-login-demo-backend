...
public class AuthenticationServiceTest {
    ...
    public void testValidLogin() throws Exception {
        //More specific exceptions for above line: SQLException | InvalidLoginException
        ...
        when(mockUserDao.getUserByUsernameAndPassword(eq("test123"), eq("test")))  //equals matches for username and password
